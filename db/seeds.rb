User.create!(first_name: "Dan Ray", last_name: "Rollan", mobile:"09560635541",email: "danray@admin.com", password: "password", password_confirmation: "password", role: User.roles[:admin])
